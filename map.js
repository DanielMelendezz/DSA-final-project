//This function claculates the distance between two points
function calculateDistance(p1, p2) {
    return Math.sqrt(Math.pow(p2.coordinates[0] - p1.coordinates[0], 2) + Math.pow(p2.coordinates[1] - p1.coordinates[1], 2));
  }

//This function calls calculatedistance and adds all the vertices to get the path length
  ...
  //The brute force aglorthim this take O(V!)
  ...
  //The nearest neighbor aglorthim this takes O(V^2)
...
//This function is called when the button is pressed and calls the brute force function
...
//This function is called when the button is pressed and calls the closet neighbor function
